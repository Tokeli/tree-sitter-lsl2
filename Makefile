LANGUAGE_NAME := tree-sitter-lsl
HOMEPAGE_URL := https://github.com/tokeli/tree-sitter-lsl2
VERSION := 0.1.0
DESCRIPTION := Linden Scripting Language
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/lsl '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/lsl
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/lsl
